    ...
    <div className="mx-auto flex h-full max-w-md flex-col px-4">
      ...
      <div className="flex flex-1 flex-col justify-center py-6">
        ...
        <motion.div
          ...
          className="relative flex min-h-[104px] items-center justify-center gap-2 rounded-3xl p-3"
          style={{
            border: slots.length
          ...
          {HAND.map((card) => {
            ...
            return (
              <motion.button
                ...
                disabled={!affordable}
                className={cn(
                  "relative flex h-28 w-[62px] flex-col items-center justify-between rounded-xl p-2 text-slate-100",
