...
export const DIALECT_VARIANTS: DialectVariant[] = [
  {
    ...
    variants: {
      msa: {
        ...
        ipa: "/jakˈtubu/",
        audioLabel: "Formal · yaktubu",
      },
      levantine: {
        script: "بْيِكْتُب",
        transliteration: "byiktub",
        ipa: "/bjiˈktub/",
        audioLabel: "Damascus · byiktub",
      },
      egyptian: {
        script: "بِيِكْتِب",
        transliteration: "biyiktib",
        ipa: "/biˈjiktib/",
        audioLabel: "Cairo · biyiktib",
      },
    },
  },
  {
    ...
    variants: {
      msa: {
        ...
        ipa: "/jadˈrusu/",
        audioLabel: "Formal · yadrusu",
      },
      levantine: {
        script: "بْيِدْرُس",
        transliteration: "byidrus",
        ipa: "/bjiˈdrus/",
        audioLabel: "Damascus · byidrus",
      },
      egyptian: {
        script: "بِيِدْرِس",
        transliteration: "biyidris",
        ipa: "/biˈjidris/",
        audioLabel: "Cairo · biyidris",
      },
    },
  },
  {
    ...
    variants: {
      msa: {
        ...
        audioLabel: "Formal · as-salāmu ʿalaykum",
      },
      levantine: {
        script: "سَلَام عَلَيْكُن",
        transliteration: "salām ʿalaykon",
        ipa: "/saˈlaːm ʕaˈlajkon/",
        audioLabel: "Damascus · salām ʿalaykon",
      },
      egyptian: {
        script: "سَلَامُو عَلَيْكُم",
        transliteration: "salāmu ʿalēkum",
        ipa: "/saˈlaːmu ʕaˈleːkom/",
        audioLabel: "Cairo · salāmu ʿalēkum",
      },
    },
  },
  {
